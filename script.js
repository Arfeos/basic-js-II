...
for(let index in programmers){
    console.log(`${programmers[index].name} ${programmers[index].lastname}, su aporte fue ${programmers[index].knowledge}`);
}
...
console.log(calcularAreaRectangulo(2,10));
console.log(calcularAreaRectangulo(6,5));
